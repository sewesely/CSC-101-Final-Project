...
#data_processing.py - Sebastian Wesley
...
#get_data - Will Bakey
#Returns a list of workable vehicle data for computation
#Removes all entries for "All" vehicle types (since they would mess with averages when computing)
def get_data():
    data = []
